    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 text-gray-100">
      ...
      <div className="pt-26 px-4 pb-6">
        <div className="w-full space-y-6">
          {/* Top Row: Lists and Activity Logs side by side */}
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
            {/* Section 1: Lists - Takes 3/4 of the space on xl screens */}
            ...
            {/* Section 2: Activity Logs - Takes 1/4 of the space on xl screens */}
            <div className="xl:col-span-1 pt-2">
              <section className="relative">
                ...
                <div className="h-[600px] bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-6 overflow-y-auto hide-scrollbar">
          ...
          {/* Section 3: Board Members (Owner/Admin only) - Full width below */}
